...
// Refactored Card Effect - Adventurer
...
void council_roomEffect(struct gameState *state, int currentPlayer, int handPos)
{
    int i;
    ...
    for (i = 0; i < state->numPlayers; i++)
  {
    ...
    discardCard(handPos, currentPlayer, state, 1); //introduced bug, change last discardCard parameter from 0 to 1
}

// Refactored Card Effect - Smithy
void smithyEffect(struct gameState *state, int currentPlayer, int handPos)
{
    int i;
    //+3 Cards
    for (i = 1; i < 3; i++) // introduced bug, i = 0 to i = 1
  {
    drawCard(currentPlayer, state);
  }
...
void minionEffect(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2)
{
    int i;
    int j;
...
// Refactored Card Effect - Sea Hag
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
 ...
 // int z = 0;// this is the counter for the temp hand
  ...
  switch( card )
    {
    case adventurer:
    /* Refactored to adventureEffect() function
    ...
    */
    ...
    case council_room:
    /* Refactored to council_roomEffect() function
    ...
    */
    ...
    case smithy:
    /* Refactored to smithyEffect() function
    ...
    */
    ...
    case minion:
    /* Refactored to minionEffect() function
    ...
    */
    ...
    case sea_hag:
    /* Refactored to sea_hagEffect() function
